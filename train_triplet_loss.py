...
parser.add_argument('--dataroot', '-d', type=str, required=False,
                    default = r'D:\NCKU\Course\Data_Science\part3\HW4\data\lfw',
...
parser.add_argument('--training_dataset_csv_path', type=str, default='datasets/train10_lfw.csv',
...
parser.add_argument('--iterations_per_epoch', default=625, type=int,
...
parser.add_argument('--resume_path', type=str,
                    default = r'D:\NCKU\Course\Data_Science\part3\HW4\facenet-pytorch-glint360k-master\model_training_checkpoints\model_train_10_resnet34_triplet_epoch_19.pt',
                    # default = None,
...
parser.add_argument('--learning_rate', default=0.0075, type=float,
...
parser.add_argument('--training_triplets_path', type=str,
                    # default = r'D:\NCKU\Course\Data_Science\part3\HW4\facenet-pytorch-glint360k-master\datasets\generated_triplets',
                    default=None,
...
def validate_lfw(model, lfw_dataloader, model_architecture, epoch, experiment_name):
    model.eval()
    with torch.no_grad():
        ...
        with open('logs/lfw_{}_{}_log_triplet.txt'.format(model_architecture, experiment_name), 'a') as f:
            val_list = [
                epoch,
                np.mean(accuracy),
                np.std(accuracy),
    ...
    try:
        ...
        plot_roc_lfw(
            ...
            figure_name="plots/roc_plots/{}_roc_{}_epoch_{}_triplet.png".format(experiment_name, model_architecture, epoch)
        )
        # Plot LFW accuracies plot
        plot_accuracy_lfw(
            log_file="logs/lfw_{}_{}_log_triplet.txt".format(model_architecture, experiment_name),
            epochs=epoch,
            figure_name="plots/accuracies_plots/{}_lfw_accuracies_{}_epoch_{}_triplet.png".format(experiment_name, model_architecture, epoch)
        )
...
def main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        with open('logs/{}_{}_log_triplet.txt'.format(model_architecture, experiment_name), 'a') as f:
            val_list = [
                epoch,
                num_valid_training_triplets
            ]
        ...
        # Save model checkpoint
        torch.save(state, 'model_training_checkpoints/model_{}_{}_triplet_epoch_{}.pt'.format(
                experiment_name,    
                model_architecture,                    
                epoch
            )
